...
- If the client persists talking about topics irrelevant to their drinking problems for more than three turns despite repeated warnings and redirects, terminate the session politely, stating that the interview must focus on their drinking problem.
...
GUARDRAIL_PROMPT_V2 = """# Safety Guidelines
